# Naming Migration Guide: LeatherDryingRack -> DryingRackFixed B42 MP
...
*   **New Title**: `DryingRackFixed B42 MP`
...
*   **Path**: `~/Zomboid/Workshop/LeatherDryingRack/` (Delete this folder once `DryingRackFixedB42MP` is present).

---

## Automated Changes (Being performed by opencode)

1.  **Mod ID Change**: `LeatherDryingRack` -> `DryingRackFixedB42MP`.
